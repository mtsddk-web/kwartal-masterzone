    ...
    <div className="animate-fade-up max-w-3xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-slate-400 text-lg max-w-xl mx-auto">
          Jakie są Twoje <span className="text-ember-400 font-medium">3 najważniejsze cele</span> na ten kwartał?
        </p>
      </div>
        ...
        {goals.map((goal, index) => (
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-ember-500 to-ember-600 flex items-center justify-center text-night-900 font-bold text-lg">
                {index + 1}
              </div>
      ...
      <div className="mt-6 p-4 bg-night-800/30 rounded-xl border border-night-700/50">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="text-sm font-medium text-slate-300 mb-1">Zasada 80/20</h4>
