    ...
    <div className="space-y-8">
      ...
      <div className="bg-night-800/60 rounded-2xl p-6 border border-night-600/50">
        <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
          <span className="w-8 h-8 rounded-lg bg-ember-500/30 flex items-center justify-center text-ember-400 text-sm font-bold">1</span>
          Fakty i wyniki
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-ember-500/50 focus:border-ember-500 resize-none"
              rows={2}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-ember-500/50 focus:border-ember-500"
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-night-800/60 rounded-2xl p-6 border border-night-600/50">
        <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
          <span className="w-8 h-8 rounded-lg bg-emerald-500/30 flex items-center justify-center text-emerald-400 text-sm font-bold">2</span>
          Co działało
          <HelpTooltip {...helpContent.retrospective} />
        </h3>
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 resize-none"
              rows={2}
            />
          </div>
      ...
      <div className="bg-night-800/60 rounded-2xl p-6 border border-night-600/50">
        <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
          <span className="w-8 h-8 rounded-lg bg-red-500/30 flex items-center justify-center text-red-400 text-sm font-bold">3</span>
          Wzorce i przeszkody
          <HelpTooltip {...helpContent.retrospective} />
        </h3>
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500 resize-none"
              rows={2}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500"
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-night-800/60 rounded-2xl p-6 border border-night-600/50">
        <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
          <span className="w-8 h-8 rounded-lg bg-indigo-500/30 flex items-center justify-center text-indigo-400 text-sm font-bold">4</span>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {/* STOP */}
          <div>
            <label className="block text-sm font-semibold text-red-400 mb-3 uppercase tracking-wider">
              STOP - co kończysz
            </label>
            <div className="space-y-2">
              {retrospective.stop.map((item, index) => (
                <input
                  ...
                  className="w-full px-3 py-2 bg-night-900/80 border border-red-500/40 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500/50 text-sm"
                />
              ))}
            </div>
          </div>
            ...
            <div className="space-y-2">
              {retrospective.continue.map((item, index) => (
                <input
                  ...
                  className="w-full px-3 py-2 bg-night-900/80 border border-emerald-500/40 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 text-sm"
                />
              ))}
            </div>
          </div>
          ...
          {/* START */}
          <div>
            <label className="block text-sm font-semibold text-amber-400 mb-3 uppercase tracking-wider">
              START - nowa zasada
            </label>
            <textarea
              ...
              className="w-full px-3 py-2 bg-night-900/80 border border-amber-500/40 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500/50 text-sm resize-none"
              rows={4}
            />
          </div>
        </div>
