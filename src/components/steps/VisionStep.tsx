    ...
    <div className="space-y-8">
      ...
      <div className="bg-night-800/60 rounded-2xl p-6 border border-night-600/50">
        ...
        <textarea
          ...
          className="w-full px-4 py-4 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-ember-500/50 focus:border-ember-500 resize-none text-lg"
          rows={4}
        />
      </div>
      ...
      <div className="bg-night-800/60 rounded-2xl p-6 border border-red-500/30">
        ...
        <textarea
          ...
          className="w-full px-4 py-3 bg-night-900/80 border border-red-500/40 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500 resize-none"
          rows={2}
        />
      </div>

      {/* Brave action */}
      <div className="bg-night-800/60 rounded-2xl p-6 border border-amber-500/30">
        <h3 className="text-lg font-semibold text-white mb-2 flex items-center gap-2">
        ...
        <input
          ...
          className="w-full px-4 py-3 bg-night-900/80 border border-amber-500/40 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500"
        />
      </div>

      {/* North Star + One Word */}
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-night-800/60 rounded-2xl p-6 border border-indigo-500/30">
          <h3 className="text-lg font-semibold text-white mb-2 flex items-center gap-2">
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-night-900/80 border border-indigo-500/40 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500"
          />
        </div>

        <div className="bg-night-800/60 rounded-2xl p-6 border border-purple-500/30">
          <h3 className="text-lg font-semibold text-white mb-2 flex items-center gap-2">
          ...
          <input
            ...
            maxLength={15}
            className="w-full px-4 py-3 bg-night-900/80 border border-purple-500/40 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 uppercase font-bold text-center text-xl tracking-widest"
          />
        </div>
      </div>
    </div>
