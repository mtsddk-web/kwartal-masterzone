    ...
    <div className="space-y-8">
      ...
      <div className="bg-night-800/60 rounded-2xl p-6 border border-night-600/50">
        <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
          <span className="w-8 h-8 rounded-lg bg-indigo-500/30 flex items-center justify-center text-indigo-400 text-sm font-bold">1</span>
          Kierunek na rok
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-white mb-2">
              Do końca {year} chcę... <span className="text-slate-400">(1 zdanie - efekt, nie lista)</span>
            </label>
            <textarea
              ...
              className="w-full px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 resize-none"
              rows={2}
            />
          </div>
            ...
            <div className="space-y-2">
              {annualPlan.successSigns.map((sign, index) => (
                <input
                  ...
                  className="w-full px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
                />
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 uppercase font-bold text-center text-xl tracking-widest"
              maxLength={15}
            />
          </div>
        </div>
      ...
      <div className="bg-night-800/60 rounded-2xl p-6 border border-night-600/50">
        <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
          <span className="w-8 h-8 rounded-lg bg-ember-500/30 flex items-center justify-center text-ember-400 text-sm font-bold">2</span>
          3 Cele roczne
          ...
          {annualPlan.goals.map((goal, index) => (
            ...
            >
                ...
                <button
                  ...
                  className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${
                    annualPlan.priorityGoal === index
                      ...
                      : 'border-slate-500 hover:border-ember-500/50'
                  }`}
                >
                  {annualPlan.priorityGoal === index && (
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-ember-500/50 mb-2 font-medium"
              />
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-ember-500/50 resize-none mb-2 text-sm"
                rows={2}
              />
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-ember-500/50 text-sm"
              />
            </div>
          ))}
          ...
          {annualPlan.priorityGoal !== undefined && (
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-ember-500/50 resize-none"
                rows={2}
              />
            </div>
          )}
      ...
      <div className="bg-night-800/60 rounded-2xl p-6 border border-night-600/50">
        <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
          <span className="w-8 h-8 rounded-lg bg-purple-500/30 flex items-center justify-center text-purple-400 text-sm font-bold">3</span>
          North Star i miary
        ...
        <div className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-white mb-2">
                Co mierzysz? <span className="text-slate-400">(nazwa metryki)</span>
              </label>
              <input
                type="text"
                ...
                className="w-full px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-white mb-2">
                Docelowa wartość <span className="text-slate-400">(cel liczbowy)</span>
              </label>
              <input
                type="text"
              ...
              {annualPlan.supportingMetrics.map((metric, index) => (
                <div key={index} className="grid grid-cols-2 gap-2">
                  <input
                    ...
                    className="px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50"
                  />
                  <input
                    type="text"
                    value={metric.target}
      ...
      <div className="bg-night-800/60 rounded-2xl p-6 border border-night-600/50">
        <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
          <span className="w-8 h-8 rounded-lg bg-cyan-500/30 flex items-center justify-center text-cyan-400 text-sm font-bold">4</span>
          Zasady gry na {year}
        ...
        <div className="space-y-2">
          {annualPlan.rules.map((rule, index) => (
            <input
              ...
              className="w-full px-4 py-3 bg-night-900/80 border border-night-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-500/50"
            />
          ))}
        </div>
      </div>
