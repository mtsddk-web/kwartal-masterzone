    ...
    <div className="animate-fade-up max-w-3xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-slate-400 text-lg max-w-xl mx-auto">
          Jakie projekty realizujesz? Pamiętaj: <span className="text-ember-400 font-medium">max 3 jednocześnie!</span>
        </p>
      </div>
      ...
      <div className={`mb-8 p-4 rounded-xl border transition-all duration-300 ${
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className={`text-2xl font-bold ${isValid ? 'text-emerald-400' : 'text-amber-400'}`}>
              {totalPercentage}%
            </span>
      ...
      <div className="space-y-6">
        {projects.map((project, index) => (
          <div
            key={index}
            className="group p-6 bg-night-800/50 border border-night-700 rounded-2xl transition-all duration-300 hover:border-night-600"
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-slate-400 text-sm">Projekt {index + 1}</span>
              </div>
              <div className="text-right">
                <span className="text-2xl font-bold text-ember-400">{project.percentage}%</span>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="w-16 text-center">
                  <input
                    ...
                    className="w-full px-2 py-1 bg-night-900/50 border border-night-700 rounded-lg text-center text-white text-sm"
                  />
                </div>
              </div>
              {/* Visual bar */}
              <div className="mt-2 h-2 bg-night-900 rounded-full overflow-hidden">
                <div
      ...
      <div className="mt-6 p-4 bg-night-800/30 rounded-xl border border-night-700/50">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="text-sm font-medium text-slate-300 mb-1">Zasada 3 projektów</h4>
