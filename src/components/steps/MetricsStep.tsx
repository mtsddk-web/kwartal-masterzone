    ...
    <div className="animate-fade-up max-w-3xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-slate-600 dark:text-slate-400 text-lg max-w-xl mx-auto">
          Jak zmierzysz sukces? Podaj <span className="text-ember-600 dark:text-ember-400 font-medium">2-3 konkretne KPI</span>
        </p>
      </div>
      ...
      <div className="space-y-4">
        {metrics.map((metric, index) => (
          <div
            key={index}
            className="group relative p-6 bg-white/80 dark:bg-night-800/50 border border-slate-200 dark:border-night-700 rounded-2xl transition-all duration-300 hover:border-slate-300 dark:hover:border-night-600 shadow-sm dark:shadow-none"
          ...
          >
            ...
            {metrics.length > 1 && (
              <button
                ...
                className="absolute top-4 right-4 w-8 h-8 rounded-lg bg-slate-100 dark:bg-night-900/50 text-slate-500 hover:bg-red-500/20 hover:text-red-400 transition-all duration-200 opacity-0 group-hover:opacity-100"
              >
      ...
      {metrics.length < 5 && (
        <button
          onClick={addMetric}
          className="mt-4 w-full p-4 border-2 border-dashed border-slate-300 dark:border-night-700 rounded-2xl text-slate-500 dark:text-slate-400 hover:border-ember-500/50 hover:text-ember-500 dark:hover:text-ember-400 transition-all duration-300 flex items-center justify-center gap-2"
        >
      ...
      <div className="mt-6 p-4 bg-slate-100/80 dark:bg-night-800/30 rounded-xl border border-slate-200 dark:border-night-700/50">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">SMART Metrics</h4>
