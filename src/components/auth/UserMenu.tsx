        ...
        <div className="absolute right-0 mt-2 w-56 bg-night-800 border border-night-700 rounded-xl shadow-xl z-[9999] overflow-hidden">
          ...
          <div className="py-2">
            ...
            <Link
              ...
              className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-300 hover:bg-night-700 hover:text-white transition-colors cursor-pointer"
            >
            ...
            <button
              onClick={() => { toggleTheme(); }}
              className="flex items-center gap-3 w-full px-4 py-2.5 text-sm text-slate-300 hover:bg-night-700 hover:text-white transition-colors cursor-pointer"
            >
              {theme === 'dark' ? (
          ...
          <div className="py-2 border-t border-night-700">
            <button
              ...
              className="flex items-center gap-3 w-full px-4 py-2.5 text-sm text-red-400 hover:bg-red-500/10 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSigningOut ? (
